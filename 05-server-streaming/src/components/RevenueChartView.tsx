...
// "use client" only because Recharts needs the browser - not because this
// fetches anything. `data` arrives already resolved as a prop, either from
// RevenueChart's internal async fetch (widget) or from app/revenue/page.tsx
// (detail).
export function RevenueChartView({ data, variant = "widget" }: { data: RevenuePoint[]; variant?: "widget" | "detail" }) {
