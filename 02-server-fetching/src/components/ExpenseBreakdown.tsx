...
// resolved and passed down as a prop from the Server Component page.
export function ExpenseBreakdown({ data, variant = "widget" }: { data: ExpensesData; variant?: "widget" | "detail" }) {
